You can use this sidebar to filter and sort the data based on the columns available in the `climate_policies` table. Here are some examples of the kinds of questions you can ask me:
